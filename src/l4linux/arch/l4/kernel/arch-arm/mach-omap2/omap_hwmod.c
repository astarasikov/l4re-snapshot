...
static int __init _register(struct omap_hwmod *oh)
{
	...
	//printk("omap_hwmod: %s registered\n", oh->name);
...
int __init omap_hwmod_register(struct omap_hwmod **ohs)
{
	...
	//printk("omap_hwmod_register\n");

	if (!ohs)
	{
	        //printk("omap_hwmod_register exit !ohs\n");
		return 0;
	}
 ...
 */
int __init omap_hwmod_setup_all(void)
{
	int r;

	//printk("omap_hwmod_setup_all\n");
